...
(function () {
  ...
  YogaReservationController.$inject = ['YogaService', 'Authentication', '$scope', '$rootScope', 'moment', '$uibModal', '$location' ];

  function YogaReservationController( YogaService, Authentication, $scope, $rootScope, moment, $location) {
