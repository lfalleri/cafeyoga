...
(function () {
  ...
  angular
    ...
    .controller('AdminYogaController', AdminYogaController);;


  AdminYogaController.$inject = ['YogaService', 'Authentication', '$scope', 'moment', '$uibModal', 'calendarConfig'];

  function AdminYogaController( YogaService, Authentication, $scope, moment, $uibModal, calendarConfig) {
