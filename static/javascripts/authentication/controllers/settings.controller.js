...
(function () {
  ...
  SettingsController.$inject = ['$location', '$scope', 'Authentication', 'YogaService'];

  /**
  * @namespace LoginController
  */
  function SettingsController($location, $scope, Authentication, YogaService) {
    var vm = this;
    ...
    function activate() {
         Authentication.getFullAccount(function(value){
            ...
            if(angular.equals($scope.account,{})){
               ...
               console.log("$scope.reservedLessonsForAccount : ",$scope.reservedLessonsForAccount);
            });
            }
         });
    }
